#!/usr/bin/env node
/**
 * Outpost MCP Server — stdio transport
 *
 ...
 * }
 *
 * Via npx (recommended — connects to hosted https://outpost.hibernyte.com):
 * {
 *   "mcpServers": {
 *     "outpost": {
 *       "command": "npx",
...
const BASE_URL = process.env.OUTPOST_BASE_URL ?? 'https://outpost.hibernyte.com';
